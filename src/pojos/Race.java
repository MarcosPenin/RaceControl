...
public abstract class Race implements Runnable {
	...
	public void driveAll() {
		for (Car car : cars) {
			...
			System.err.println(car.getPiloto() + ":    " + car.getDistance());
		}
	}
	...
	/**
	 * Accede al torneo asociado a esta carrera. Si es un torneo de un solo garage
	 * añade todos sus coches a la carrera. Si es de varios escoge aleatoriamente un
	 * coche de cada garage y lo añade a la carrera
	 * 
	 * @return Nada
