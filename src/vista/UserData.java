...
public class UserData {
	...
	/**
	 * Pregunta al usuario si un torneo se reservará a un solo garage o tendrá
	...
	/**
	 * Permite seleccionar los garages que participarán en un torneo de entre los
	 * garages guardados
	 * 
	...
	public static ArrayList<Garage> requestGarages(boolean onlyOneGarage) {
		...
		if (addNow && !RaceControlApp.almacen.getGarages().isEmpty()) {
			int op, i;
			do {
				do {
				...
				newGarage = RaceControlApp.almacen.getGarages().get(op - 1);
	...
	/**
	 * Pregunta si el usuario quiere visualizar los torneos actuales o el histórico
	 * de torneos
	 * 
